...
; Modified by Gemini (Nov 2025) - Blue Ring & 1 Minute Round
;
...
COLOR_BACKGROUND        = $84 ; <--- MUDEI AQUI: Fundo Azul (Era Verde)
...
; Interleaves graphics data in the assembled ROM.
;
...
.initGameVariables
	...
	lda #ONE_IDX_VALUE << 4 | COLON_IDX_VALUE ; <--- MUDEI AQUI: 1 Minuto no relogio
